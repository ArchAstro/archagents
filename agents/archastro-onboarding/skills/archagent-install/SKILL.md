...
6. **On success**, tell the user the CLI is ready and suggest they run `archagent setup` to install the Claude Code/Codex plugins, then `archagent auth login <email>` to authenticate.
