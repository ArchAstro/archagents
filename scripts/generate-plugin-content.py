...
USAGE
    ...
    Manifest consistency checks (version and name agreement across the
    three plugin manifest files) have moved to scripts/check_plugin_repo.py.
    CI runs both scripts; developers should run both locally before pushing.
